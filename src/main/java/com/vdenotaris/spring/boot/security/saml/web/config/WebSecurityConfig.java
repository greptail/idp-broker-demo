...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId(clientId);
    ...
    /**
     * Returns the authentication manager currently used by Spring. It represents a bean definition with the aim allow wiring
     * from other classes performing the Inversion of Control (IoC).
     * 
     * @throws Exception
     */
    @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/").permitAll().antMatchers("/saml/**").permitAll().antMatchers("/css/**")
                .permitAll().antMatchers("/img/**").permitAll().antMatchers("/js/**").permitAll().anyRequest().authenticated();
